...
//  TODO: Move towards above in getting all tests to pass
  val amountProducedValues: Map[String, Option[AmountProduced]] = Map(
    "amount produced large" -> Some(Large)
//    "amount produced small" -> Some(Small),
//    "amount produced none" -> Some(NoneProduced),
//    "" -> None
  ...
  val thirdPartyPackagingValues: Map[String, Option[Boolean]] = Map("" -> None)
  val ownBrandsValues: Map[String, Option[Boolean]] = Map("producing own brands" -> Some(true))
  val contractValues: Map[String, Option[Boolean]] = Map("contract packing" -> Some(true))
  val importValues: Map[String, Option[Boolean]] = Map("importing" -> Some(true))
