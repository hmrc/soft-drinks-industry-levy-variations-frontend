...
trait ModelGenerators {
  ...
  implicit lazy val arbitraryUpdateRegisteredDetailsChangeRegisteredDetails
    : Arbitrary[updateRegisteredDetails.ChangeRegisteredDetails] =
    Arbitrary {
