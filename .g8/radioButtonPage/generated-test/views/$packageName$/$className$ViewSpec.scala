  ...
  "View" - {
    ...
    "contains a form with the correct action" - {
      "when in CheckMode" in {
        val htmlAllSelected = view(form.fill($className$.values.head), CheckMode)(using request, messages(application))
      ...
      "when in NormalMode" in {
        val htmlAllSelected = view(form.fill($className$.values.head), NormalMode)(using request, messages(application))
        val documentAllSelected = doc(htmlAllSelected)
