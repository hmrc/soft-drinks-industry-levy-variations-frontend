...
class PackingSiteDetailsRemoveControllerISpec extends ControllerITTestHelper {
  ...
  val normalRoutePath = "//packaging-site-details/remove"
  val checkRoutePath = "/change-/packaging-site-details/remove"

  "GET " + normalRoutePath - {
    "when the userAnswers contains no data" - {
      "should return OK and render the PackingSiteDetailsRemove page with no data populated" in {
        given
          .commonPrecondition
    ...
    userAnswersForUpdateRegisteredDetailsPackingSiteDetailsRemovePage.foreach { case (key, userAnswers) =>
          ...
          "when the session contains no data for page" in {
            ...
            WsTestClient.withClient { client =>
              ...
              whenReady(result) { res =>
                ...
                val dataStoredForPage = getAnswers(userAnswers.id).fold[Option[Boolean]](None)(_.get(PackingSiteDetailsRemovePage))
