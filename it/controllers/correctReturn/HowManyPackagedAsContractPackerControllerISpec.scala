...
class HowManyPackagedAsContractPackerControllerISpec extends LitresISpecHelper {
  ...
  val userAnswers =
    emptyUserAnswersForCorrectReturn.set(HowManyPackagedAsContractPackerPage, litresInBands).success.value
  ...
  List(NormalMode, CheckMode).foreach { mode =>
    ...
    s"POST " + path - {
            ...
            WsTestClient.withClient { client =>
              ...
              whenReady(result) { res =>
                ...
                val dataStoredForPage = getAnswers(userAnswers.id)
                  .fold[Option[LitresInBands]](None)(_.get(HowManyPackagedAsContractPackerPage))
      ...
      "should return 400 with required error" - {
        val errorTitle =
          "Error: " + "How many litres of liable drinks have you packaged as a third party or contract packer at UK sites you operate? - Soft Drinks Industry Levy - GOV.UK"
