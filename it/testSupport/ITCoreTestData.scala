...
trait ITCoreTestData
    extends TryValues with ITCoreTestDataForUpdateRegisteredDetails with ITCoreTestDataForCancelRegistration
    with ITCoreTestDataForChangeActivity with ITCoreTestDataForCorrectReturn {
  ...
  val packAtBusinessAddressSite = Map(
    "1" -> Site(
      UkAddress(List("63 Clifton Roundabout", "Worcester"), "WR53 7CX", None),
      Some("Super Lemonade Plc"),
      None,
      None
    )
  )
  val packAtBusinessAddressSites =
    Map(
      ...
      "siteDOS" -> Site(
        UkAddress(List("64 Clifton Roundabout", "Worcester"), "WR53 7CX", None),
        Some("Super Lemonade Plc"),
        None,
        None
      )
