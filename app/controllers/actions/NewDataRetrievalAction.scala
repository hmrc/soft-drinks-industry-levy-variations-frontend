...
class NewDataRetrievalActionImpl @Inject()(
                                         val sessionRepository: SessionRepository,
                                         val sdilSessionCache: SDILSessionCache
                                       )(implicit val executionContext: ExecutionContext) extends NewDataRetrievalAction {
...
trait NewDataRetrievalAction extends ActionTransformer[IdentifierRequest, OptionalDataRequest]
