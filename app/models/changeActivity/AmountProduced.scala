...
sealed trait AmountProduced

object AmountProduced extends Enumerable.Implicits {

  case object Large extends WithName("large") with AmountProduced
  case object Small extends WithName("small") with AmountProduced
