...
object ChangeActivitySummary {
  ...
  def summaryListsAndHeadings(userAnswers: UserAnswers, isCheckAnswers: Boolean)(implicit
    ...
    val contractSummary: SummaryList =
    ...
    val ownBrandsSection: Option[(String, SummaryList)] =
    ...
    val contractSection: Option[(String, SummaryList)] =
      if (contractSummary.rows.isEmpty) None
      else {
        Option(
    ...
    val importsSection: Option[(String, SummaryList)] =
      if (importsSummary.rows.isEmpty) None
      else {
        Option(
    ...
    val sitesSection: Option[(String, SummaryList)] =
      if (userAnswers.getChangeActivityData.exists(_.isVoluntary)) None
      else {
