...
class ChangeActivityOrchestratorSpec extends SpecBase with MockitoSugar with DataHelper{
...
//      lazy val res = changeActivityOrchestrator.submitVariation(subscription = retrievedSubData, userAnswers = userAnswers)
//
