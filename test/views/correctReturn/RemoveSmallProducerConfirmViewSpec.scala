  ...
  "View" - {
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("Are you sure you want to remove this small producer?")
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe Messages("Select yes if you want to remove this small producer")
      }
    }
