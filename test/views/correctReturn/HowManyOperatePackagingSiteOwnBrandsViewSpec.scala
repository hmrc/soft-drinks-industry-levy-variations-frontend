    ...
    List(NormalMode, CheckMode).foreach { mode =>
      "when in " + mode +" mode" - {
        ...
        "should have the expected title" in {
          document.title() must include(Messages("correctReturn.howManyOperatePackagingSiteOwnBrands.title"))
        }
        ...
        "and the form has errors" - {
          val errorTitle = "Error: " + Messages("correctReturn.howManyOperatePackagingSiteOwnBrands.title")
