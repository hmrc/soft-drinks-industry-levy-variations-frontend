  ...
  "View" - {
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("correctReturn.claimCreditsForLostDamaged.title")
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe Messages("correctReturn.claimCreditsForLostDamaged.error.required")
      }
    }
