...
class PackagingSiteDetailsViewSpec extends ViewSpecHelper {
  ...
  "View" - {
    ...
    "should contain the expected title" in {
      document.title() must include(Messages("correctReturn.packagingSiteDetails" + ".title"))
    }

    "should include a legend with the expected heading" in {
      val legend = document.getElementsByClass(Selectors.legend)
      legend.size() mustBe 1
      legend.get(0).getElementsByClass(Selectors.heading).text() mustEqual Messages("correctReturn.packagingSiteDetails.heading")
    }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("correctReturn.packagingSiteDetails.title")
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe Messages("correctReturn.packagingSiteDetails.error.required")
      }
    }
