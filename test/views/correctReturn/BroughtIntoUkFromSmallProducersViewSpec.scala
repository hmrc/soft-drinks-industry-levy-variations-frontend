  ...
  "View" - {
    ...
    "should include a legend with the expected heading" in {
      ...
      legend
        ...
        .text() mustEqual "Are you reporting liable drinks you have brought into the UK from small producers?"
    }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        documentWithErrors.title must include(
          "Error: Are you reporting liable drinks you have brought into the UK from small producers? - Soft Drinks Industry Levy - GOV.UK"
        )
      }
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary
          .text() mustBe "Select yes if are you reporting liable drinks you have brought into the UK from small producers?"
      }
    }
