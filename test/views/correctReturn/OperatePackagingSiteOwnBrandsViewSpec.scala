...
import views.html.correctReturn.OperatePackagingSiteOwnBrandsView
class OperatePackagingSiteOwnBrandsViewSpec extends ViewSpecHelper {
  ...
  "View" - {
    ...
    "should contain the expected title" in {
      document.title() must include(Messages("correctReturn.operatePackagingSiteOwnBrands" + ".title"))
    }

    "should include a legend with the expected heading" in {
      val legend = document.getElementsByClass(Selectors.legend)
      legend.size() mustBe 1
      legend.get(0).getElementsByClass(Selectors.heading).text() mustEqual Messages("correctReturn.operatePackagingSiteOwnBrands.heading")
    }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("correctReturn.operatePackagingSiteOwnBrands.title")
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe Messages("correctReturn.operatePackagingSiteOwnBrands.error.required")
      }
    }
