...
class RemovePackagingSiteConfirmViewSpec extends ViewSpecHelper {
  ...
  "View" - {
    ...
    "should contain the expected title" in {
      document.title() must include(Messages("correctReturn.removePackagingSiteConfirm" + ".title"))
    }
    ...
    "contains a form with the correct action" - {
      "when in CheckMode" - {
        ...
        "and yes is selected" in {
          documentYesSelected
            ...
            .attr("action") mustEqual routes.RemovePackagingSiteConfirmController.onSubmit(CheckMode, index).url
        }
      ...
      "when in NormalMode" - {
        ...
        "and yes is selected" in {
          documentYesSelected
            .select(Selectors.form)
            .attr("action") mustEqual routes.RemovePackagingSiteConfirmController.onSubmit(NormalMode, index).url
        }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        val titleMessage = Messages("correctReturn.removePackagingSiteConfirm.title")
