  ...
  "View" - {
    ...
    "should include a legend with the expected heading" in {
      ...
      legend
        ...
        .text() mustEqual "Do you bring liable drinks into the UK from anywhere outside of the UK?"
    }
    ...
    "when there are form errors" - {
      ...
      "should have a title containing error" in {
        documentWithErrors.title must include(
          "Error: Do you bring liable drinks into the UK from anywhere outside of the UK?"
        )
      }
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary
          .text() mustBe "Select yes if do you bring liable drinks into the UK from anywhere outside of the UK"
      }
    }
