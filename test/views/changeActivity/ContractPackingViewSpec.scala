...
class ContractPackingViewSpec extends ViewSpecHelper {
  ...
  val view: ContractPackingView = application.injector.instanceOf[ContractPackingView]
  ...
  "View" - {
    ...
    "should include a legend with the expected heading" in {
      ...
      legend.get(0).getElementsByClass(Selectors.heading).text() mustEqual
        "Do you operate any packaging sites in the UK to package liable drinks as a third party or contract packer?"
    }
    ...
    "when there are form errors" - {
      ...
      "contains a message that links to field with error" in {
        ...
        errorSummary.text() mustBe "Select yes if you operate any packaging sites in the UK to package liable drinks as a third party or contract packer"
      }
    }
