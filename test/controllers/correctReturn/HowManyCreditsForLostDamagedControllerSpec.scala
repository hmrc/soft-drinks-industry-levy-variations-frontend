...
class HowManyCreditsForLostDamagedControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val howManyCreditsForLostDamagedRoute: String =
  ...
  "HowManyCreditsForLostDamaged Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        emptyUserAnswersForCorrectReturn.set(HowManyCreditsForLostDamagedPage, LitresInBands(100, 200)).success.value
