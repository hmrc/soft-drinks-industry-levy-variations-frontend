  ...
  def postRequest(): FakeRequest[AnyContentAsFormUrlEncoded] =
    FakeRequest(POST, cancelRegistrationDateRoute)
      .withFormUrlEncodedBody(
        "cancelRegistrationDate.day"   -> validAnswer.getDayOfMonth.toString,
        "cancelRegistrationDate.month" -> validAnswer.getMonthValue.toString,
        "cancelRegistrationDate.year"  -> validAnswer.getYear.toString
      )
