...
class RemoveWarehouseDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val removeWarehouseDetailsRoute =
  ...
  "RemoveWarehouseDetails Controller" - {
    ...
    testInvalidJourneyType(UpdateRegisteredDetails, removeWarehouseDetailsRoute)
    testRedirectToPostSubmissionIfRequired(UpdateRegisteredDetails, removeWarehouseDetailsRoute)
