...
class ReturnPeriodSpec extends SpecBase with DataHelper {

  "ReturnPeriod" - {
    "start returns the start date of the quarter" in {
      val firstSdilReturnPeriod = testReturnPeriod(2018, 1)
    ...
    "next returns the next Return" in {
      val quarter0 = testReturnPeriod(2023, 0)
      ...
      quarter0.next mustBe ReturnPeriod(2022, 1)
